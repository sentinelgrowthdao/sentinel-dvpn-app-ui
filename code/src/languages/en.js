export default {
  ...
  log_in_with_your_key_title: "Access Wallet with your key",
  ...
  already_have_a_wallet: "Already have a wallet?",
  connect: "Connect",
  ...
  login_fetching_wallet: "Fetching Wallet Details",
  ...
  logout_title: "Remove?",
  logout_desc: "Make sure you have a copy of your keys otherwise you cannot recover your wallet.",
  cancel: "Cancel",
  ...
  no_granter: "No Granter (Use your own DVPN tokens)",
  legal: "Legal",
  ...
  modal_subscription_description: "Purchase one month of subscription from a decentralized contract on",
  modal_no_subscriptions_link_text: "Sentinel's Blockchain",
  modal_subscription_title: "You do not have an active subscription",
  renew_at_price: "Renew for {{price}} DVPN",
  ...
  error_register_wallet: "Error while registering Wallet",
  ...
  no_balance_description: "You have insufficient tokens in your wallet!",
  ...
  intro_slides_one_text_one: "Sentinel Shield is a fully decentralized, open-source, and peer to peer VPN application. Browse the internet with no centralized servers or obscure code monitoring you.",
  ...
  intro_slides_three_text_two: "is used as a payment for subscription in this application. The current rate for 1 month of subscription is 1333.33 $DVPN. New payment methods will be added in the near future.",
  intro_slides_two_link_one: "Node Map",
  intro_slides_two_link_two: "Download the Sentinel Whitepaper",
  intro_slides_two_text_one: "Servers hosted on Sentinel are hosted by individuals from all over the world. These servers communicate directly with the Sentinel blockchain to indicate their availability, and the Sentinel Shield dVPN scans the Sentinel blockchain to identify available servers.",
  ...
  buy_now: "Buy Now",
  get_some_dvpn_foot_note: "You're purchasing {{tokens}} DVPN tokens for {{amount}}. Payment will be charged to your iTunes Account. DVPN tokens are for decentralized VPN services only. By proceeding, you confirm you've read our Terms of Service and Privacy Policy.",
  ...
  dvpn_are_on_the_way: "Payment of {{value}} successful",
  dvpn_are_on_the_way_desc: "Your payment was successfully completed using your {{from}} account. Tokens are on the way. If they don't arrive, please contact support.",
};
