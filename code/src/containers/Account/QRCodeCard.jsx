  ...
  return (
    <Card className={`${styles.root} p-16 my-16`}>
      <section className={styles.top}>
        <Text text={"wallet_address"} className="fs-14 fw-5 text-9cabc9" />
        <Text text={parseWalletAddress(walletAddress)} className="fs-14 fw-5" />
      </section>
      <section className={styles.middle}>
        <QRCode value={walletAddress} level={"L"} />
      </section>
